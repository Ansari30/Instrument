...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><a href="#">Manually Update Categories</a></li>
      </ol>
   </section>
            ...
            <div class="box">
               <div class="box-header">
                  ...
                  <div class="pull-right">   
                     ...
                     <i class="fa fa-plus"></i> Update Categories
                     </button>
               ...
               <!-- /.box-header -->
               <div class="box-body">
                  <form name="searchdata" id="searchdata" method="" action="<?php echo base_url('admin/manually_update'); ?>">
                     ...
                     <tr>
                        ...
                        <td class="pull-center">
                         <div class="form-group">
                           <input type="text" name="page_title[]" value="" class="form-control" autocomplete="off"> 
                          </div> 
                          </div> 
                        </td>
                        <td class="pull-center">
                         <div class="form-group">
                           <input type="text" name="image[]" value="" class="form-control" autocomplete="off"> 
                          </div> 
                        </td>
                        <td class="pull-center">
                         <div class="form-group">
                           <input type="text" name="meta_keywords[]" value="" class="form-control" autocomplete="off"> 
                         </div>  
                        </td>
                        <td class="pull-center">
                         <div class="form-group">
                           <input type="text" name="meta_description[]" value="" class="form-control" autocomplete="off"> 
                         </div> 
                        </td>
