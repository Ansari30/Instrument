      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="box">
               ...
               <!-- /.box-header -->
                <form name="uploadfile" id="uploadfile" action="<?php echo base_url('admin/'.$this->controllerName.'/category_8999_match_data'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="box-body">
