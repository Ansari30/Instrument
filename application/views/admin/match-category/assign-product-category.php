...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         Assigned category to product
         <!--<small>advanced tables</small>-->
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url('admin')?>"><i class="fa fa-dashboard"></i> Home</a></li>
         <li class="active"><a href="#">Update Categories</a></li>
      </ol>
   </section>
      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="box">
               ...
               <!-- /.box-header -->
                <form name="uploadfile" id="uploadfile" action="<?php echo base_url('admin/'.$this->controllerName.'/assigned_category_to_product'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="box-body">
