...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><a href="#">Update Budgetbox</a></li>
      </ol>
   </section>
      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="box">
               ...
               <!-- /.box-header -->
                <form name="uploadfile" id="uploadfile" action="<?php echo base_url('admin/'.$this->controllerName.'/relatedupload'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="box-body">
